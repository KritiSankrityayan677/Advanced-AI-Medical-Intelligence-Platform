...
def _parse_sections(text: str) -> Dict[str, str]:
    """Split the LLM output into its four labelled sections."""
    sections = {"findings": "", "impression": "", "recommendation": "", "disclaimer": ""}
    labels = {
        "findings:": "findings",
...
def generate_report(prediction: Dict) -> Dict:
    ...
    if not sections["disclaimer"]:
        sections["disclaimer"] = (
            "This report was generated by an automated AI system and is NOT a "
            "medical diagnosis. It must be reviewed by a qualified radiologist "
            "or physician before any clinical decision."
        )
